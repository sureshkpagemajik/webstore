...
package com.webstore.customers.controller;
...
import com.webstore.customers.customer.service.CustomerGroupService;
import com.webstore.customers.customer.service.CustomerMasterService;
...
//		}
	...
	public @ResponseBody String addCustomer(@RequestParam(required = false, value = "callback") String callback,
		...
		System.out.println(" addCustomer - id : "+id);
		JSONObject jsonObject = new JSONObject();
		if ( id > 0 ) {
			try {
				jsonObject.put("status", 1);
