 ...
 * #L%
 */
package com.webstore.customers.customer.dao.impl;

import org.hibernate.SessionFactory;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Repository;

import com.webstore.customers.customer.dao.CustomerDAO;
...
public class CustomerDAOImpl extends GenericHibernateDAO<Customer, Integer> implements CustomerDAO {
	...
	public Customer getCustomerByEmailId(String email) {
		return (Customer) this.sessionFactory.getCurrentSession().createQuery("from Customer where email=?").setParameter(0, email).uniqueResult();
