...
//	public ProductsMaster() {}
	...
	public HashMap<String, String> toAttributedHashMap(){
		...
		attributedMap.put("shortDescription", shortDescription);
		attributedMap.put("sku", sku);
		attributedMap.put("weight", weight+"");
		attributedMap.put("fromDate", fromDate);
		attributedMap.put("toDate", toDate);
		attributedMap.put("status", status);
		attributedMap.put("urlKey", urlKey);
		...
		attributedMap.put("hasMoreOption", hasMoreOption+"");
		attributedMap.put("requiredOption", requiredOption+"");
		attributedMap.put("categoryId", categoryId+"");
