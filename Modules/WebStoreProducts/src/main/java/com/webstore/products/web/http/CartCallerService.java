package com.webstore.products.web.http;
...
public class CartCallerService {
	
	public static String sendCartDetails(String GET_URL,String USER_AGENT) throws IOException {
